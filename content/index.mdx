<Interstitials.Hero
  headline="V&A Chinese Ceramics Collection"
  description="This is a test website made by Liana. I drew from the Collections of the V&A museum in London, and selected Chinese ceramics, to display on a sample Canopy site. I inserted descriptions from the V&A website without proper attribution, as this is a sample website."
  background="theme"
  random={true}
  links={[
    {
